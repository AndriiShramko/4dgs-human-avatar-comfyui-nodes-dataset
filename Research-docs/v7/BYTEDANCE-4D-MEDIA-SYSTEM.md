...
- **Legal strategy (§6.7):** No new trap, but a **reconfirmation** of the existing pattern — permissive-looking new code (MIT) sitting on top of a non-commercial Inria rasterizer. TaoGS is very likely to repeat this exactly once its code lands; assume non-commercial until proven otherwise.
