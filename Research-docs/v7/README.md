...
Cross-cutting docs: [LEGAL-LICENSING.md](LEGAL-LICENSING.md) (license map, the wall, GPL business model, GDPR package — DRAFT, not legal advice) · [DATASET-STATUS.md](DATASET-STATUS.md) (what actually exists: currently zero data, placeholder nodes) · [MVP-0-EXPERIMENT.md](MVP-0-EXPERIMENT.md) (the six cheap experiments that come before any real spend) · [LANDING-SYNC.md](LANDING-SYNC.md) (work order for the contradicting landing page) · [FLUX3-SPLIT-VIEW.md](FLUX3-SPLIT-VIEW.md) (2026-07-27 assessment: why the FLUX 3 "split view" is a prompt, not a feature, and where a general video generator may and may not touch this pipeline) · [MARIGOLD-V2-DENSE-PRIORS.md](MARIGOLD-V2-DENSE-PRIORS.md) (2026-09-10 assessment: Marigold V2 as the first end-to-end permissively-licensed depth/normal/albedo prior for the fit loss — what it closes, what it does not, and the temporal probe E-06 that decides it).
